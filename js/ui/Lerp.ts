...
export class Lerp extends Component {
    ...
    lerp(slider: Object3D, target: Object3D, value: number) {
        ...
        vec3.lerp(
            tempVec,
            slider.getPositionWorld(tempSliderVec),
            target.getPositionWorld(tempTargetVec),
            value
        );
        ...
        quat.lerp(
            tempquat,
            slider.getRotationWorld(tempSliderQuat),
            target.getRotationWorld(tempTargetQuat),
            value
        );
        /** assign the lerp result to the slider **/
